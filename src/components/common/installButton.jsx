    ...
    <>
      {isInstallable && (
        <motion.div
          ...
          className="fixed bottom-36 md:bottom-20 right-6 z-50 flex items-center bg-primary text-white shadow-lg cursor-pointer rounded-full transition-all duration-300 ease-in-out overflow-hidden"
          style={{
